...
**현재 상태: 로컬 통합·업데이트·재시작 검증, GitHub 공개 Release, 공개 자산 SHA-256 확인까지 통과했다. 사용자 BRAT 업데이트·정상 작동 확인은 아직 남아 있으므로 7단계 전체 완료로 선언하지 않는다.**

공개 Release: https://github.com/tlatndms2-droid/md-palette/releases/tag/0.1.0

- `main.js`: `c5e9a52ad3a7ffe0e07740c352bf55387c3f94540ab29c1ddf9f996e94ba034a`
- `manifest.json`: `d5ccede553f1bb4208a20c570bc72160fdad64b8235f9bb513ced65023e1ee85`
- `styles.css`: `165663fe1b18d2eba161947315a09f9866e3455314d53fbe06a627265ba5a8cf`
...
1. 사용자의 0.1.0 BRAT 업데이트·확인. 사용자 담당이며 이번에 대신 수행하지 않았다.
