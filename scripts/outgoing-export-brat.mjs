...
try{
 ...
 const old=dir+'/before';
 assert.equal(JSON.parse(await readFile(old+'/manifest.json','utf8')).version,'0.1.11');
 ...
 await wait(`${p}?.manifest.version==='0.1.12'&&!!${p}.mainFile`);
 ...
 const result={passed:true,from:'0.1.11',version:'0.1.12',through:'BRAT 2.2.0 public download and reload',priorSettingsPreserved:true,assets};
