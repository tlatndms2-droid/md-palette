...
## 현재 버전: 0.0.11 — Folder 제목 카드·Main 토글
...
6단계 드래그 재사용은 후속 단계입니다. Main 본문 자체의 링크 클릭 팝업은 보류 상태이며, 위 선택 메뉴는 Metadata View의 Links에 적용합니다.
...
4. 표시 버전이 `0.0.11`인지 확인합니다. 기존 설치자는 BRAT 업데이트를 실행합니다.

이번 수정의 사용자 확인과 별도 요청 후에 6단계로 진행합니다. BRAT 설치·업데이트 확인은 사용자가 담당합니다.
